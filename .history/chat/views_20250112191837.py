...
def chat_room(request, room_id):
    ...
    if chat_room.project:
        ...
        if project_status_request:
            # Customer can approve developer's request and vice versa
            can_approve_request = (
                (is_customer and project_status_request.requester_type == 'developer') or
                (is_developer and project_status_request.requester_type == 'customer')
            )
